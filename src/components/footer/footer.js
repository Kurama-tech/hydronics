...
import companylogo from 'assets/images/icons/company.png';
      ...
      <Container>
        <Flex sx={styles.footerInner}>
          <Flex sx={styles.copyright}>
            {/* <Logo isWhite /> 
            <img src={companylogo} width={138} height="auto"/>*/}
            <Text as="span">
              &copy; Copyright by {new Date().getFullYear()} Hydronic Systems
            </Text>
          </Flex>
